...
href="<?php echo $ctalink; ?>">
				...
				<?php endif; ?>
					...
					<?php
					if ( ! is_search() && ! ( 'yes' == $home_hero_style ) ) :
						if ( get_field( 'show_quickbooker' ) == true ) :
							get_template_part( 'templates/content/page', 'booking-widget' );
						endif;
					endif;
		...
		<!-- <section class="page-banner hero" style="background-image:url('https://www.addisonlee.com/wp-content/uploads/2017/09/7292_ALee_SHOT2_R3_landscape-1.jpg')">
			<div class="content-header"></div>
						...
						<?php
						$app_banner_display = get_field( 'display_banner' );
						if ( 'show' === $app_banner_display ) :

							$app_banner_title = get_field( 'app_banner_title' ) ? get_field( 'app_banner_title' ) : 'Download The App';
							$app_banner_text  = get_field( 'app_banner_text' ) ? get_field( 'app_banner_text' ) : 'Book in advance or on the move';
							$app_banner_terms = get_field( 'terms_and_conditions_link' ) ? get_field( 'terms_and_conditions_link' ) : '';
							$app_banner_image = get_field( 'app_image' ) ? get_field( 'app_image' ) : '/wp-content/themes/addlee/assets/images/iPhone-X-Angle-min.png';
							?>
		<section id="home-app-cta" class="template-section beige flexi-cta full beige">
			<div class="container">
				<div class="row lazyloaded bg-app-download" data-bg="<?php echo $app_banner_image; ?>" style="background-image: url('<?php echo $app_banner_image; ?>');">
					<div class="col-md-9 outer-content">
						<div class="content">
							<h2><?php echo wpautop( esc_html( $app_banner_title ) ); ?></h2>
							<div class="offer"><?php echo wp_kses( $app_banner_text, $allowed_html ); ?></div>
							...
							<?php if ( ! empty( $app_banner_terms ) ) : ?>
							<p class="terms"><a href="<?php echo esc_url( $app_banner_terms ); ?>">*T&amp;C's apply</a></p>
								<?php
								else :
									echo '<p class="terms">*T&amp;C\'s apply</p>';
								endif;
								?>
						</div>
					</div>
