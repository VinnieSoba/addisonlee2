...
class ORG_PFL_DTL
{
  ...
  /**
   * 
   * @var TRD_DATA_AVLB_DTL $TRD_DATA_AVLB_DTL
   * @access public
   */
  ...
  /**
   * 
   * @var YRS_IN_BUS_DTL $YRS_IN_BUS_DTL
   * @access public
   */
   ...
   * @param TRD_DATA_AVLB_DTL $TRD_DATA_AVLB_DTL
   * @param ORG_SZ_DTL $ORG_SZ_DTL
   * @param YRS_IN_BUS_DTL $YRS_IN_BUS_DTL
   * @access public
   */
