...
class Orders
{
   ...
   * @access public
   */
  public function __construct($User_Language, $DnB_DUNS_Number, $Country_Code, $Trade_Up_Indicator, $Product, $Product_Type, $Reason_Code, $FileId, $SBRI_Unmatched_AGN, $Char_Set_Override, $Endorsement)
  {
