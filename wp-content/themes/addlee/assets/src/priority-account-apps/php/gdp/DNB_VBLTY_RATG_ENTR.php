...
class DNB_VBLTY_RATG_ENTR
{
  ...
  /**
   * 
   * @var PTFL_CMPA_SCR $PTFL_CMPA_SCR
   * @access public
   */
  ...
  /**
   * 
   * @var DATA_DPTH_DTL $DATA_DPTH_DTL
   * @access public
   */
   ...
   * @param VBLTY_SCR $VBLTY_SCR
   * @param PTFL_CMPA_SCR $PTFL_CMPA_SCR
   * @param DATA_DPTH_DTL $DATA_DPTH_DTL
   * @param ORG_PFL_DTL $ORG_PFL_DTL
   * @access public
   */
