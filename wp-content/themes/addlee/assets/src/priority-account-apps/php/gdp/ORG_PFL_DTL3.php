...
class ORG_PFL_DTL3
{
  ...
  /**
   * 
   * @var TRD_DATA_AVLB_DTL3 $TRD_DATA_AVLB_DTL
   * @access public
   */
  ...
  /**
   * 
   * @var YRS_IN_BUS_DTL3 $YRS_IN_BUS_DTL
   * @access public
   */
   ...
   * @param TRD_DATA_AVLB_DTL3 $TRD_DATA_AVLB_DTL
   * @param ORG_SZ_DTL3 $ORG_SZ_DTL
   * @param YRS_IN_BUS_DTL3 $YRS_IN_BUS_DTL
   * @access public
   */
