...
class DNB_VBLTY_RATG_ENTR3
{
  ...
  /**
   * 
   * @var PTFL_CMPA_SCR3 $PTFL_CMPA_SCR
   * @access public
   */
  ...
  /**
   * 
   * @var DATA_DPTH_DTL3 $DATA_DPTH_DTL
   * @access public
   */
   ...
   * @param VBLTY_SCR3 $VBLTY_SCR
   * @param PTFL_CMPA_SCR3 $PTFL_CMPA_SCR
   * @param DATA_DPTH_DTL3 $DATA_DPTH_DTL
   * @param ORG_PFL_DTL3 $ORG_PFL_DTL
   * @access public
   */
